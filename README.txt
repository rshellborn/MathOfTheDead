...
Each of our pages is in a separate html file, which you will find in the general section of our folder.  We organize all other elements into sub-folders.  We are using Javascript for nearly all game logic, CSS for styling, and mongoDB (specifically mLab) for the leaderboard database.
